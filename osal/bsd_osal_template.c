...
int bsd_osal_init(void) { return 0; }

void *bsd_osal_malloc(size_t size) { return 0; }
void *bsd_osal_realloc(void *ptr, size_t size) { return 0; }
void bsd_osal_free(void *ptr) {}
char *bsd_osal_strdup(const char *str, size_t *lenp) { return 0; }

void bsd_osal_callout_init(bsd_osal_callout_t c) {}
void bsd_osal_callout_destory(bsd_osal_callout_t c) {}
int bsd_osal_callout_reset(bsd_osal_callout_t c, int timeout, bsd_callout_func_t ftn, void *arg) { return 0; }
void bsd_osal_callout_stop(bsd_osal_callout_t c) {}
void bsd_osal_callout_drain(bsd_osal_callout_t c) {}
int bsd_osal_callout_schedule(bsd_osal_callout_t c, int to_ticks) { return 0; }
...
bool bsd_osal_mtx_own(bsd_osal_mutex_t m) { return false; }
void bsd_osal_mtx_assert(bsd_osal_mutex_t m) {}
int bsd_osal_mtx_sleep(bsd_osal_mutex_t m, int timeout) { return 0; }
...
int bsd_osal_cv_wait(bsd_osal_condvar_t c, uint32_t timeout) { return 0; }
...
uint32_t bsd_osal_get_tick_rate(void) { return 0; }
uint64_t bsd_osal_get_current_tick(void) { return 0; }

int bsd_osal_intr_disable(void) { return 0; }
void bsd_osal_intr_restore(int flag) {}
void bsd_osal_intr_setup_irq(int irqno, bsd_intr_handle_t handler, void *arg) {}
int bsd_osal_intr_teardown(int irqno) { return 0; }
int bsd_osal_intr_active(int irqno) { return 0; }
int bsd_osal_intr_deactivate(int irqno) { return 0; }

uint8_t bsd_osal_read_uint8(uintptr_t base, size_t offset) { return 0; }
uint16_t bsd_osal_read_uint16(uintptr_t base, size_t offset) { return 0; }
uint32_t bsd_osal_read_uint32(uintptr_t base, size_t offset) { return 0; }
uint64_t bsd_osal_read_uint64(uintptr_t base, size_t offset) { return 0; }
...
int bsd_osal_printf(int level, const char *fmt, ...) { return 0; }
int bsd_osal_dev_printf(int level, const char *dev_name, const char *fmt, ...) { return 0; }
